package rujianbin.oauth2.resource.server.config;
...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    @Value("${oauth2.check-token-endpoint}")
    private String checkTokenEndpoint;
    @Value("${oauth2.check-token-username}")
    private String checkTokenUsername;
    @Value("${oauth2.check-token-secret}")
    ...
    public ResourceServerTokenServices resourceServerTokenServices(){
        ...
        resourceServerTokenServices.setClientSecret(checkTokenSecret);
