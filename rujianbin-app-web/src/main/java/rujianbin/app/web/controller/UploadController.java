...
import rujianbin.app.web.bean.FileMeta;
...
public class UploadController {
    ...
    public FileMeta upload(MultipartHttpServletRequest request, HttpServletResponse response) {
        ...
        while(itr.hasNext()){
            ...
            fileMeta.setUrl("/rujianbin-app-web/file/download/"+fileMeta.getUuid());
            try {
                fileMeta.setBytes(mpf.getBytes());

                // copy file to local disk (make sure the path "e.g. D:/temp/files" exists)
                String path = this.getClass().getClassLoader().getResource("").getPath().replace("/target/classes","/upload");
    ...
    public void get(HttpServletResponse response,@PathVariable String uuid){
